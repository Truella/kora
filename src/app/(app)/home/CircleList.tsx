...
function CircleCard({ circle }: { circle: HomeCircle }) {
  ...
  return (
    <div className="relative flex flex-col rounded-[20px] border-[0.5px] border-border bg-surface shadow-[0_12px_30px_rgba(11,38,36,0.05)] transition-[transform,box-shadow,border-color] duration-200 ease-out hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-[0_18px_40px_rgba(11,38,36,0.09)] focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2 focus-within:ring-offset-bg active:translate-y-0 active:scale-[0.99]">
      <Link
        href={circle.href}
